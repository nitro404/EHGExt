...
SingletonManager::SingletonManager(const SingletonManager & singletonManager) {

}

SingletonManager & SingletonManager::operator = (const SingletonManager & singletonManager) {
	return *this;
}
...
bool SingletonManager::isCreated() {
	return m_singletons != NULL;
}
